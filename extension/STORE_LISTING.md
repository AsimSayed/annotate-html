...
Click any element on any page, write feedback, copy structured markdown. Built for AI coding agents like Claude Code and Cursor.

## Detailed description

Point at things on any webpage. Tell your AI agent what to change.

Annotate HTML adds a small toolbar to any page. Toggle annotation mode, click an element, type your feedback, and copy everything as clean markdown — ready to paste into Claude Code, Cursor, or any AI coding assistant.
...
Zero data collection. No analytics, no tracking, no network requests. Everything stays in your browser tab and disappears when you close it. Minimal permissions: activeTab and scripting only.

OPEN SOURCE

MIT licensed. Source code: github.com/AsimSayed/annotate-html
